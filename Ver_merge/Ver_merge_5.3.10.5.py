...
# 캐릭터 객체 생성
ch = obj("/Users/ho/Git/KKLHY/캐릭터/Step_0_2_4.png")
# 캐릭터 위치 초기화
ch.x_pos = 0;
ch.y_pos = -80 + screen_height / 2
ch.speed = 1  # 이동 속도
# 선생님 객체 생성/크기(80,196)
teach = obj("/Users/ho/Git/KKLHY/캐릭터/teacher.png")
...
# 선생님 무기
tw = obj("/Users/ho/Git/KKLHY/아이템/F.png")
...
# 무기 객체 생성/크기(40,42)
wp = item("/Users/ho/Git/KKLHY/아이템/weapon.png")
wp.speed = 5
wp.x_pos = ch.x_pos;
wp.y_pos = ch.y_pos
...
# 배경화면 객체 초기화
bglist = [
    obj("/Users/ho/Git/KKLHY/배경/background_0.png"),
    obj("/Users/ho/Git/KKLHY/배경/background_1.png"),
    obj("/Users/ho/Git/KKLHY/배경/background_2.png"),
    obj("/Users/ho/Git/KKLHY/배경/background_3.png"),
    obj("/Users/ho/Git/KKLHY/배경/NextStage.png")
]
gameover = pygame.image.load("/Users/ho/Git/KKLHY/배경/Gameover.png")
...
F_it = [
    item("/Users/ho/Git/KKLHY/아이템/F.png"),
    item("/Users/ho/Git/KKLHY/아이템/F.png"),
    item("/Users/ho/Git/KKLHY/아이템/F.png"),
    item("/Users/ho/Git/KKLHY/아이템/F.png"),
    item("/Users/ho/Git/KKLHY/아이템/F.png"),
...
# 폰트 정의
game_font = pygame.font.Font("/Users/ho/Git/KKLHY/폰트/NanumBrush.ttf", 40)  # 폰트 객체  생성(폰트,크기)
...
while flags[2]:
    ...
    # 타이머 집어 넣기
    # 경과 시간 계산
    elapsed_time = (pygame.time.get_ticks() - start2_ticks) / 1000  # 시간단위가 ms 라서 1000으로 나누어 s 단위로 표시
    if score < 0 or elapsed_time > 60:
        screen.blit(gameover, (0, 0))
